...
router.get("/callback", passport.authenticate('admin', { successRedirect:"https://membership-management.netlify.app/",failureRedirect: 'https://membership-management-backend.onrender.com/api/error' }), adminController.logIn)
